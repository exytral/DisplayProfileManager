...
namespace DisplayProfileManager.Tests.Tests
{
    ...
    public class CloneGroupTopologyTests
    {
        ...
        public void SourceModesRequired_ForCloneGroup_EqualsUniqueSourceIdCount()
        {
            ...
            Assert.AreNotEqual(uniqueSourceIds, totalEnabledCount, "Per-display iteration would consume 2 source modes for a group that only has 1.");
        }
        ...
        public void SourceModesRequired_ForExtendedDisplays_EqualsTotalDisplayCount()
        {
            ...
            Assert.AreEqual(totalEnabledCount, uniqueSourceIds, "Extended displays each have a unique SourceId, so unique count equals total.");
        }
        ...
        public void SourceModesRequired_ForMixedConfig_EqualsUniqueSourceIdCount()
        {
            ...
            Assert.AreEqual(2, uniqueSourceIds, "2 clone members + 1 extended display requires exactly 2 source modes.");
        }
        ...
        public void DisableNonProfileDisplays_TargetsDisplaysOutsideProfile()
        {
            ...
            Assert.AreEqual(2, disabled, "Displays not in the profile must be disabled; only those in the profile are kept active.");
        }
        ...
        public void ApplyDisplayPosition_DoesNotExist()
        {
            ...
            Assert.IsNull(method, "ApplyDisplayPosition must not exist — position is set inside ApplyDisplayLayout.");
        }
        ...
        public void ApplyDisplayTopology_ExistsAsPublicStaticMethod()
        {
            ...
            Assert.IsNotNull(method, "ApplyDisplayTopology must exist as the single topology entry point.");
        }
        ...
        public void EnableDisplays_DoesNotExistAsStandaloneMethod()
        {
            ...
            Assert.IsNull(enableDisplays, "EnableDisplays must not exist as a separate method — it was folded into ApplyDisplayTopology.");
        }
    }
}