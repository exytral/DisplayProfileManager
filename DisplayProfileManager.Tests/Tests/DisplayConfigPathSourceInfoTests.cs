...
namespace DisplayProfileManager.Tests.Tests
{
    ...
    public class DisplayConfigPathSourceInfoTests
    {
        ...
        public void CloneGroupId_DoesNotExistAsProperty()
        {
            ...
            Assert.IsNull(prop, "CloneGroupId must not exist — clone group is encoded in the lower 16 bits of modeInfoIdx.");
        }
        ...
        {
            var info = new DisplayConfigHelper.DisplayConfigPathSourceInfo();
            info.ResetModeAndSetCloneGroup(0);

            Assert.AreEqual(0xFFFFu, info.modeInfoIdx >> 16, "The upper half must be the invalid source-mode index, or Windows reads a real mode index.");
        }
        ...
        public void ResetModeAndSetCloneGroup_SetsUpperBitsToInvalid()
        {
            ...
            Assert.AreEqual(0xFFFFu, src.modeInfoIdx >> 16, "Upper 16 bits must be 0xFFFF (invalid source mode index) after ResetModeAndSetCloneGroup.");
        }
        ...
        public void ResetModeAndSetCloneGroup_CalledTwice_ReplacesNotAccumulates()
        {
            ...
            Assert.AreEqual(0xFFFF_0007u, src.modeInfoIdx, "Second call must overwrite completely, not OR into the previous value.");
        }
        ...
        public void DirectAssignment_OverwritesEntireField()
        {
            ...
            Assert.AreEqual(2u, src.modeInfoIdx, "Direct assignment must overwrite the entire modeInfoIdx field.");
        }
